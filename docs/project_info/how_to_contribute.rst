...
Bugs can be reported using the issue section in `github <https://github.com/Acribbs/TallyNN/issues>`_
...
If you wish to contribute a new feature to the TallyNN repository then the best way is to raise this as an issue and label it as an enhancement in `github <https://github.com/Acribbs/TallyNN/issues>`_
